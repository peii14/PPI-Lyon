...
const Navbar = () => {
  return (
    <nav className="w-screen bg-primary opacity-80 py-5 max-h-16 fixed z-50">
          ...
          <Disclosure>
            {({ open }) => (
              <>
                ...
                >
                  <Disclosure.Panel className="w-9/12 mx-auto bg-primary p-5">
                    <ul className="flex flex-col text-left gap-5">
                      <li className="hover:bg-sec ">
