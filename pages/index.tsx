                  ...
                  <div className="grid md:grid-flow-col grid-flow-row gap-20">
                    <div className="">
                      ...
                      <ul className={s.listed}>
                        <li>
                          Mewujudkan Perhimpunan Pelajar Indonesia Lyon (PPI
                          Lyon) sebagai wadah untuk memaksimalkan potensi dan
                          aspirasi pelajar Indonesia di Lyon
                        </li>
                        <li>
                        ...
                        <li>
                          Menjadikan PPI Lyon menjadi role model bagi
                    ...
                    <div>
                      ...
                      <ul className={s.listed}>
                        ...
                        <li>
                          Memperkenalkan kota Lyon ke Indonesia sebagai kota
                          ke-3 terbesar di Prancis
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="flex md:flex-row flex-col gap-10 text-primary">
                  ...
                  <div className="max-w4xl md:mt-5 mt--">
                    ...
                    <p className="mt-5 text-justify">
                      "Kami ingin PPI Lyon bisa menjadi wadah untuk
                      memaksimalkan potensi dan aspirasi pelajar Indonesia di
                      Lyon, juga membangun ekosistem pelajar yang bersahabat dan
